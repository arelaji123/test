...
const settingContentEl = document.getElementById("sContent");
const initialTextEl = document.getElementById("initialTextEl");
const afterDOBBtnTxtEl = document.getElementById("afterDOBButton");
const dobButtonEl = document.getElementById("dobBTN");
const dobInputEl = document.getElementById("DOBItem");
